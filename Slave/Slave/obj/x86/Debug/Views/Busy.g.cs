#pragma checksum "C:\Users\Jervis\OneDrive\HotelAirConditionerControlSys_MVVM_UWP\Slave\Slave\Views\Busy.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "410AD94FEC23B3DE09AFED9B2044AC86"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Slave.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class Busy_obj1_Bindings :
            ...
            IBusy_Bindings
        {
            private global::Slave.Views.Busy dataRoot;
            ...
            public void SetDataRoot(global::Slave.Views.Busy newDataRoot)
            {
                this.bindingsTracking.ReleaseAllListeners();
            ...
            private void Update_(global::Slave.Views.Busy obj, int phase)
            {
            ...
            private class Busy_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_IsBusy(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::Slave.Views.Busy obj = sender as global::Slave.Views.Busy;
        if (obj != null)
        {
        ...
        bindings.UpdateFallback_BusyText(DATA_CHANGED);
                ...
                public void UpdateChildListeners_(global::Slave.Views.Busy obj)
                {
                    Busy_obj1_Bindings bindings;
                    if(WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::Slave.Views.Busy.IsBusyProperty, tokenDPC_IsBusy);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::Slave.Views.Busy.BusyTextProperty, tokenDPC_BusyText);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_IsBusy = obj.RegisterPropertyChangedCallback(global::Slave.Views.Busy.IsBusyProperty, DependencyPropertyChanged_IsBusy);
                            tokenDPC_BusyText = obj.RegisterPropertyChangedCallback(global::Slave.Views.Busy.BusyTextProperty, DependencyPropertyChanged_BusyText);
                        }
                    }
                }
            }
